...
class UserNotification(models.Model):
    ...
    un_from = models.ForeignKey(User, to_field="username", db_column='un_from',related_name='usernotification_to', on_delete=models.CASCADE, max_length=20, null=False)
    un_to = models.ForeignKey(User, to_field="username", db_column='un_to',related_name='usernotification_from', on_delete=models.CASCADE, max_length=20, null=False)
    un_send_date = models.DateField(default=datetime.now)
