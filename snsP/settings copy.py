...
cred_path = os.path.join(BASE_DIR, "ownway-firebase-adminsdk-servicekey.json")
...
AWS_S3_ACCESS_KEY_ID = my_settings.AWS_S3_ACCESS_KEY_ID
AWS_S3_SECRET_ACCESS_KEY = my_settings.AWS_S3_SECRET_ACCESS_KEY
